...
public class Level33 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.level33); //Установили текст
        ...
        btn_up_left.setTextSize(TypedValue.COMPLEX_UNIT_SP, 16);
        btn_up_right.setTextSize(TypedValue.COMPLEX_UNIT_SP, 14);
        btn_bottom_left.setTextSize(TypedValue.COMPLEX_UNIT_SP, 16);
        btn_bottom_right.setTextSize(TypedValue.COMPLEX_UNIT_SP, 14);
        //Меняем размер текста в кнопках конец

        //Меняем текст в кнопках - начало
        btn_up_left.setText(R.string.lvl33textone);
        btn_up_right.setText(R.string.lvl33texttwo);
        btn_bottom_left.setText(R.string.lvl33textthree);
        btn_bottom_right.setText(R.string.lvl33textfour);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(Level33.this); //Показать рекламу
                    Intent intent = new Intent(Level33.this, PlayGame.class);
        ...
        buttoncontinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Level33.this, Level34.class); //ИЗМЕНИТЬ
                    startActivity(intent);
                    finish();
                }catch (Exception e){
                    //Пусто
        ...
        buttoncontinueback1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Level33.this, Level33.class);
                    startActivity(intent);
                    finish();
                }catch (Exception e){
                    //Пусто
            ...
            public void onClick(View v) {
                ...
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    ...
                    try {
                        ...
                        Intent intent = new Intent(Level33.this, PlayGame.class); //Создали намерение для перехода
                        startActivity(intent);
                        finish();
        ...
        btn_up_left.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (mediaPlayer!=null){
                        releaseMP();
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.eggs2); //Изменять
                        mediaPlayer.start();
