...
public class Level25 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textlevel2.setText(R.string.lvlcouplet25);
        //Устанавливаем текст для уровня - конец



        //Меняем текст в кнопках - начало
        btn_up_left.setText(R.string.lvl25textone);
        btn_up_right.setText(R.string.lvl25texttwo);
        btn_bottom_left.setText(R.string.lvl25textthree);
        btn_bottom_right.setText(R.string.lvl25textfour);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(Level25.this);
                    Intent intent = new Intent(Level25.this, PlayGame.class);
        ...
        buttoncontinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(Level25.this);
                    Intent intent = new Intent(Level25.this, Level26.class); //ИЗМЕНИТЬ
                    startActivity(intent);
                    finish();
                } else {
                    try {
        ...
        buttoncontinue1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(Level25.this); // показать рекламу
                    Intent intent = new Intent(Level25.this, Level26.class); //ИЗМЕНИТЬ
                    startActivity(intent);
                    finish();
                } else {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(Level25.this); //Показать рекламу
                    Intent intent = new Intent(Level25.this, PlayGame.class); //Создали намерение для перехода
                    startActivity(intent);
                    finish();
                }else {
                    try {
        ...
        btn_up_left.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (mediaPlayer!=null){
                        releaseMP();
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.olesia2); //Изменять
                        mediaPlayer.start();
        ...
        btn_up_right.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (mediaPlayer!=null){
                        releaseMP();
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.olesia2);
                        mediaPlayer.start();
    ...
    protected void onResume() {
        ...
        if (mediaPlayer == null & Clicked == 0) { //Если свернули игру до нажатия варианта ответа
            mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.olesia1);
            mediaPlayer.start();
