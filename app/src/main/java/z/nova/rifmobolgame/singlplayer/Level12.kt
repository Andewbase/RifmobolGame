...
class Level12 : AppCompatActivity() {
    ...
    private val roundFactory = RoundFactory(12, this@Level12)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        roundFactory.dialogWinCreate(this@Level12, Level13::class.java) //TODO Установить следующий уровень
        //Вызов диалогового окна Выйграл "В Конце" - конец

        //Вызов диалогового окна Проиграл "В Конце" - начало
        roundFactory.dialogLoseCreate(this@Level12, Level12::class.java, Level13::class.java) //TODO Установить повторяющийся, следующий уровень
        //Вызов диалогового окна Проиграл "В Конце" - конец

        //Кнопка "Назад" - начало
        btnBack.setOnClickListener {
            //Обрабатывем нажатие кнопки "Назад" - начало
            roundFactory.clickBackButton(this@Level12)
        }
        //Кнопка "Назад" - конец
