...
public class Level1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button btn_bottom_right = (Button) findViewById(R.id.btn_right_bottom);//Создаём нижнюю правоую кнопку
        final Button btn_bottom_left = (Button) findViewById(R.id.btn_left_bottom);//Создаём нижнюю левую кнопку
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) {
                    Yodo1Mas.getInstance().showInterstitialAd(Level1.this); //Показать рекламу
                    Intent intent1 = new Intent(Level1.this, PlayGame.class );
                   startActivity(intent1);
                   finish();
                } else {
                    try {
                        Intent intent = new Intent(Level1.this, PlayGame.class);
        ...
        buttoncontinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Level1.this, Level2.class); //ИЗМЕНИТЬ
                    startActivity(intent);
                    finish();
                }catch (Exception e){
                    //Пусто
            ...
            public void onClick(View v) {
                ...
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    ...
                    try {
                        ...
                        Intent intent = new Intent(Level1.this, PlayGame.class); //Создали намерение для перехода
                        startActivity(intent);
                        finish();
        ...
        btn_up_left.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (mediaPlayer!=null){
                        releaseMP();
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.watchman2);
                        mediaPlayer.start();
    ...
    protected void onResume() {
        ...
        if (mediaPlayer == null & Clicked == 0) { //Если свернули игру до нажатия варианта ответа
            mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.watchman1);
            mediaPlayer.start();
