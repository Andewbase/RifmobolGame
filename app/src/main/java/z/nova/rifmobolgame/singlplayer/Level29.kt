...
class Level29 : AppCompatActivity() {

    val roundInfoImpl = RoundInfoImpl(29)
   ...
   lateinit var dialogEndLose //Создаем Диалог Проиграл
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_bottom_right.setTextSize(TypedValue.COMPLEX_UNIT_SP, 12f)
        ...
        btnclose.setOnClickListener {
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@Level29) //Показать рекламу
                val intent = Intent(this@Level29, PlayGame::class.java)
        ...
        buttoncontinue.setOnClickListener {
            try {
                val intent = Intent(this@Level29, Level30::class.java) //ИЗМЕНИТЬ
                startActivity(intent)
                finish()
            } catch (e: Exception) {
                //Пусто
        ...
        buttoncontinueback1.setOnClickListener {
            try {
                val intent = Intent(this@Level29, Level29::class.java)
                startActivity(intent)
                finish()
            } catch (e: Exception) {
                //Пусто
        ...
        btn_back.setOnClickListener {
            ...
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                ...
                try {
                    ...
                    val intent =
                        Intent(this@Level29, PlayGame::class.java) //Создали намерение для перехода
                    startActivity(intent)
                    finish()
