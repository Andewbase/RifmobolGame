...
class Level13 : AppCompatActivity() {
    ...
    private val singlRoundFactory = SinglRoundFactory(13, this@Level13)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_up_left.setTextSize(TypedValue.COMPLEX_UNIT_SP, 16f)
        btn_up_right.setTextSize(TypedValue.COMPLEX_UNIT_SP, 14f)
        btn_bottom_left.setTextSize(TypedValue.COMPLEX_UNIT_SP, 16f)
        ...
        singlRoundFactory.dialogWinCreate(this@Level13, Level14::class.java) //TODO Установить следующий уровень
        //Вызов диалогового окна Выйграл "В Конце" - конец

        //Вызов диалогового окна Проиграл "В Конце" - начало
        singlRoundFactory.dialogLoseCreate(this@Level13, Level13::class.java, Level14::class.java) //TODO Установить повторяющийся, следующий уровень
        //Вызов диалогового окна Проиграл "В Конце" - конец

        //Кнопка "Назад" - начало
        btnBack.setOnClickListener {
            //Обрабатывем нажатие кнопки "Назад" - начало
            singlRoundFactory.clickBackButton(this@Level13)
        }
        //Кнопка "Назад" - конец
