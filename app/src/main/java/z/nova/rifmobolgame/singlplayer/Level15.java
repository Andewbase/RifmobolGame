...
public class Level15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_up_left.setText(R.string.lvl15textone);
        btn_up_right.setText(R.string.lvl15texttwo);
        btn_bottom_left.setText(R.string.lvl15textthree);
        btn_bottom_right.setText(R.string.lvl15textfour);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(Level15.this);
                    Intent intent = new Intent(Level15.this, PlayGame.class);
        ...
        buttoncontinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(Level15.this);
                    Intent intent = new Intent(Level15.this, Level16.class); //ИЗМЕНИТЬ
                    startActivity(intent);
                    finish();
                } else {
                    try {
        ...
        buttoncontinueback1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(Level15.this); // показать рекламу
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(Level15.this); //Показать рекламу
                    Intent intent = new Intent(Level15.this, PlayGame.class); //Создали намерение для перехода
                    startActivity(intent);
                    finish();
                }else {
                    try {
        ...
        btn_up_left.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (mediaPlayer!=null){
                        releaseMP();
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.grope2); //Изменять
                        mediaPlayer.start();
