...
public class Level10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_up_left.setText(R.string.lvl10textone);
        btn_up_right.setText(R.string.lvl10texttwo);
        btn_bottom_left.setText(R.string.lvl10textthree);
        btn_bottom_right.setText(R.string.lvl10textfour);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(Level10.this);
                    Intent intent = new Intent(Level10.this, PlayGame.class);
        ...
        buttoncontinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(Level10.this); // показать рекламу
                    Intent intent = new Intent(Level10.this, Level11.class); //ИЗМЕНИТЬ
                    startActivity(intent);
                } else {
                    try {
                        Intent intent = new Intent(Level10.this, Level11.class); //ИЗМЕНИТЬ
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(Level10.this); //Показать рекламу
                    Intent intent = new Intent(Level10.this, PlayGame.class); //Создали намерение для перехода
                    startActivity(intent);
                    finish();
                }else {
                    try {
        ...
        btn_up_left.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (mediaPlayer!=null){
                        releaseMP();
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.discotwo2); //Изменять
                        mediaPlayer.start();
