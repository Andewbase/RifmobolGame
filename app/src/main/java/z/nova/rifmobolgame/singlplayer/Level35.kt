...
class Level35 : AppCompatActivity() {
    ...
    val roundInfoImpl = RoundInfoImpl(35)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnclose.setOnClickListener {
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@Level35)
                val intent = Intent(this@Level35, PlayGame::class.java)
        ...
        buttoncontinue.setOnClickListener {
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@Level35)
                val intent = Intent(this@Level35, PlayGame::class.java) //ИЗМЕНИТЬ
                startActivity(intent)
                finish()
            } else {
                try {
        ...
        buttoncontinueback1.setOnClickListener {
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@Level35)
                val intent = Intent(this@Level35, Level35::class.java)
                startActivity(intent)
                finish()
            } else {
                try {
        ...
        buttoncontinue1.setOnClickListener {
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@Level35) // показать рекламу
                val intent = Intent(this@Level35, PlayGame::class.java) //ИЗМЕНИТЬ
                startActivity(intent)
                finish()
            } else {
        ...
        btn_back.setOnClickListener {
            ...
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@Level35) //Показать рекламу
                val intent =
                    Intent(this@Level35, PlayGame::class.java) //Создали намерение для перехода
                startActivity(intent)
                finish()
            } else {
                try {
        ...
        btn_up_left.setOnClickListener {
            try {
                ...
                if (mediaPlayer != null) {
                    releaseMP()
                    mediaPlayer =
                        MediaPlayer.create(applicationContext, roundInfo.music2) //Изменять
                    mediaPlayer?.start()
