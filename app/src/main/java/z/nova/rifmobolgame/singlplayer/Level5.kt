...
class Level5 : AppCompatActivity() {
    ...
    val roundInfoImpl = RoundInfoImpl(5)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnclose.setOnClickListener {
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@Level5)
                val intent = Intent(this@Level5, PlayGame::class.java)
        ...
        buttoncontinue.setOnClickListener {
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@Level5) // показать рекламу
                val intent = Intent(this@Level5, Level6::class.java) //ИЗМЕНИТЬ
                startActivity(intent)
                finish()
            } else {
                try {
        ...
        buttoncontinueback1.setOnClickListener {
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@Level5)
                val intent = Intent(this@Level5, Level5::class.java)
                startActivity(intent)
                finish()
            } else {
                try {
        ...
        btn_back.setOnClickListener {
            ...
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@Level5)
                val intent =
                    Intent(this@Level5, PlayGame::class.java) //Создали намерение для перехода
                startActivity(intent)
                finish()
            } else {
                try {
