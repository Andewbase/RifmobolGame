...
public class Level9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_up_right.setTextSize(TypedValue.COMPLEX_UNIT_SP, 12);
        btn_bottom_left.setTextSize(TypedValue.COMPLEX_UNIT_SP, 12);
        btn_bottom_right.setTextSize(TypedValue.COMPLEX_UNIT_SP, 10);
        ...
        btn_up_left.setText(R.string.lvl9textone);
        btn_up_right.setText(R.string.lvl9texttwo);
        btn_bottom_left.setText(R.string.lvl9textthree);
        btn_bottom_right.setText(R.string.lvl9textfour);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(Level9.this); //Показать рекламу
                    Intent intent = new Intent(Level9.this, PlayGame.class);
        ...
        buttoncontinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Level9.this, Level10.class); //ИЗМЕНИТЬ
                    startActivity(intent);
                    finish();
                }catch (Exception e){
                    //Пусто
            ...
            public void onClick(View v) {
                ...
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    ...
                    try {
                        ...
                        Intent intent = new Intent(Level9.this, PlayGame.class); //Создали намерение для перехода
                        startActivity(intent);
                        finish();
        ...
        btn_up_left.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (mediaPlayer!=null){
                        releaseMP();
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.disco2); //Изменять
                        mediaPlayer.start();
