...
public class Level20 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_up_left.setText(R.string.lvl20textone);
        btn_up_right.setText(R.string.lvl20texttwo);
        btn_bottom_left.setText(R.string.lvl20textthree);
        btn_bottom_right.setText(R.string.lvl20textfour);
        ...
        btn_up_left.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (mediaPlayer!=null){
                        releaseMP();
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.lilies2); //Изменять
                        mediaPlayer.start();
