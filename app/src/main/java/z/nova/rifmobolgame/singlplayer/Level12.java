...
public class Level12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_up_left.setTextSize(TypedValue.COMPLEX_UNIT_SP, 18);
        btn_up_right.setTextSize(TypedValue.COMPLEX_UNIT_SP, 18);
        ...
        btn_up_left.setText(R.string.lvl12textone);
        btn_up_right.setText(R.string.lvl12texttwo);
        btn_bottom_left.setText(R.string.lvl12textthree);
        btn_bottom_right.setText(R.string.lvl12textfour);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(Level12.this); //Показать рекламу
                    Intent intent = new Intent(Level12.this, PlayGame.class);
        ...
        buttoncontinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Level12.this, Level13.class); //ИЗМЕНИТЬ
                    startActivity(intent);
                    finish();
                }catch (Exception e){
                    //Пусто
            ...
            public void onClick(View v) {
                ...
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    ...
                    try {
                        ...
                        Intent intent = new Intent(Level12.this, PlayGame.class); //Создали намерение для перехода
                        startActivity(intent);
                        finish();
        ...
        btn_up_left.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (mediaPlayer!=null){
                        releaseMP();
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.dres2); //Изменять
                        mediaPlayer.start();
