...
class Level25 : AppCompatActivity() {
    ...
    val roundInfoImpl = RoundInfoImpl(25)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnclose.setOnClickListener {
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@Level25)
                val intent = Intent(this@Level25, PlayGame::class.java)
        ...
        buttoncontinue.setOnClickListener {
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@Level25)
                val intent = Intent(this@Level25, Level26::class.java) //ИЗМЕНИТЬ
                startActivity(intent)
                finish()
            } else {
                try {
        ...
        buttoncontinueback1.setOnClickListener {
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@Level25)
                val intent = Intent(this@Level25, Level25::class.java)
                startActivity(intent)
                finish()
            } else {
                try {
        ...
        buttoncontinue1.setOnClickListener {
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@Level25) // показать рекламу
                val intent = Intent(this@Level25, Level26::class.java) //ИЗМЕНИТЬ
                startActivity(intent)
                finish()
            } else {
        ...
        btn_back.setOnClickListener {
            ...
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@Level25) //Показать рекламу
                val intent =
                    Intent(this@Level25, PlayGame::class.java) //Создали намерение для перехода
                startActivity(intent)
                finish()
            } else {
                try {
