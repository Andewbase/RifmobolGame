...
class Level11 : AppCompatActivity() {
    ...
    val roundInfoImpl = RoundInfoImpl(11)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnclose.setOnClickListener {
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@Level11) //Показать рекламу
                val intent = Intent(this@Level11, PlayGame::class.java)
        ...
        buttoncontinue.setOnClickListener {
            try {
                val intent = Intent(this@Level11, Level12::class.java) //ИЗМЕНИТЬ
                startActivity(intent)
                finish()
            } catch (e: Exception) {
                //Пусто
        ...
        buttoncontinueback1.setOnClickListener {
            try {
                val intent = Intent(this@Level11, Level11::class.java)
                startActivity(intent)
                finish()
            } catch (e: Exception) {
                //Пусто
        ...
        btn_back.setOnClickListener {
            ...
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                ...
                try {
                    ...
                    val intent =
                        Intent(this@Level11, PlayGame::class.java) //Создали намерение для перехода
                    startActivity(intent)
                    finish()
