...
class Level11 : AppCompatActivity() {
    ...
    private val roundFactory = RoundFactory(11, this@Level11)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        roundFactory.setTextRound(text_levels, textLevelCouplet, btn_up_left, btn_up_right, btn_bottom_left, btn_bottom_right)

        //Вызов диалогового окна Выйграл "В Конце" - начало
        roundFactory.dialogWinCreate(this@Level11, Level12::class.java) //TODO Установить следующий уровень
        //Вызов диалогового окна Выйграл "В Конце" - конец

        //Вызов диалогового окна Проиграл "В Конце" - начало
        roundFactory.dialogLoseCreate(this@Level11, Level11::class.java, Level12::class.java) //TODO Установить повторяющийся, следующий уровень
        //Вызов диалогового окна Проиграл "В Конце" - конец

        //Кнопка "Назад" - начало
        btnBack.setOnClickListener {
            //Обрабатывем нажатие кнопки "Назад" - начало
            roundFactory.clickBackButton(this@Level11)
        }
        //Кнопка "Назад" - конец
