...
class Level1 : AppCompatActivity() {
    ...
    private val singlRoundFactory = SinglRoundFactory(1,this@Level1)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        singlRoundFactory.dialogWinCreate(this@Level1, Level2::class.java)
        //Вызов диалогового окна Выйграл "В Конце" - конец

        //Вызов диалогового окна Проиграл "В Конце" - начало
        singlRoundFactory.dialogLoseCreate(this@Level1, Level1::class.java, Level2::class.java)
        //Вызов диалогового окна Проиграл "В Конце" - конец

        //Кнопка "Назад" - начало
        btnBack.setOnClickListener {singlRoundFactory.clickBackButton(this@Level1)}
        //Кнопка "Назад" - конец

        //Обрабатываем нажатие на "Левую Верхнюю Кнопку" - начало
        btn_up_left.setOnClickListener {
            singlRoundFactory.clickButtonRoundLose(1,btn_up_left, btn_bottom_left)
        ...
        btn_up_right.setOnClickListener {
            singlRoundFactory.clickButtonRoundLose(2, btn_up_right, btn_bottom_left)
        ...
        btn_bottom_right.setOnClickListener {
            singlRoundFactory.clickButtonRoundLose(4, btn_bottom_right, btn_bottom_left)
            //Метод показывающий правельный ответ - конец
    ...
    override fun onBackPressed() { singlRoundFactory.clickBackButton(this@Level1) }
