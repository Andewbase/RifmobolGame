...
class Level1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btn_bottom_right =
            findViewById<View>(R.id.btn_right_bottom) as Button //Создаём нижнюю правоую кнопку
        val btn_bottom_left =
            findViewById<View>(R.id.btn_left_bottom) as Button //Создаём нижнюю левую кнопку
        ...
        btnclose.setOnClickListener {
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) {
                Yodo1Mas.getInstance().showInterstitialAd(this@Level1) //Показать рекламу
                val intent1 = Intent(this@Level1, PlayGame::class.java)
                startActivity(intent1)
                finish()
            } else {
                try {
                    val intent = Intent(this@Level1, PlayGame::class.java)
        ...
        buttoncontinue.setOnClickListener {
            try {
                val intent = Intent(this@Level1, Level2::class.java) //ИЗМЕНИТЬ
                startActivity(intent)
                finish()
            } catch (e: Exception) {
                //Пусто
        ...
        buttoncontinueback1.setOnClickListener {
            try {
                val intent = Intent(this@Level1, Level1::class.java)
                startActivity(intent)
                finish()
            } catch (e: Exception) {
                //Пусто
        ...
        btn_back.setOnClickListener {
            ...
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                ...
                try {
                    ...
                    val intent =
                        Intent(this@Level1, PlayGame::class.java) //Создали намерение для перехода
                    startActivity(intent)
                    finish()
        ...
        btn_up_left.setOnClickListener {
            try {
                ...
                mediaPlayer?.setOnCompletionListener {
                    ...
                    Handler().postDelayed({ dialogEndLose!!.show() }, 500)
                    //ВЫХОД ИЗ ТРЭКА (Задержка 0.3 секунды) - Начало
                }
            ...
            try {
                ...
                mediaPlayer!!.setOnCompletionListener {
                    btn_bottom_left.background =
                        resources.getDrawable(R.drawable.style_btn_stroke_whiteblack_press_whitgreen)
                    //ВЫХОД ИЗ ТРЭКА (Задержка 0.3 секунды) - Начало
                    Handler().postDelayed({ dialogEndWin!!.show() }, 500)
                    //ВЫХОД ИЗ ТРЭКА (Задержка 0.3 секунды) - Конец
                }
                //Метод показывающий правельный ответ - конец
                btn_bottom_left.background =
