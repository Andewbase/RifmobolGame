...
public class Level16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_up_left.setText(R.string.lvl16textone);
        btn_up_right.setText(R.string.lvl16texttwo);
        btn_bottom_left.setText(R.string.lvl16textthree);
        btn_bottom_right.setText(R.string.lvl16textfour);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(Level16.this); //Показать рекламу
                    Intent intent = new Intent(Level16.this, PlayGame.class);
        ...
        buttoncontinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Level16.this, Level17.class); //ИЗМЕНИТЬ
                    startActivity(intent);
                    finish();
                }catch (Exception e){
                    //Пусто
            ...
            public void onClick(View v) {
                ...
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    ...
                    try {
                        ...
                        Intent intent = new Intent(Level16.this, PlayGame.class); //Создали намерение для перехода
                        startActivity(intent);
                        finish();
        ...
        btn_up_left.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (mediaPlayer!=null){
                        releaseMP();
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.ilove2); //Изменять
                        mediaPlayer.start();
