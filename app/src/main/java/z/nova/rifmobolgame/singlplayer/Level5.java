...
public class Level5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textlevel2.setText(R.string.lvlcouplet5);
        //Устанавливаем текст для уровня - конец



        //Меняем текст в кнопках - начало
        btn_up_left.setText(R.string.lvl5textone);
        btn_up_right.setText(R.string.lvl5texttwo);
        btn_bottom_left.setText(R.string.lvl5textthree);
        btn_bottom_right.setText(R.string.lvl5textfour);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(Level5.this);
                    Intent intent = new Intent(Level5.this, PlayGame.class);
        ...
        buttoncontinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(Level5.this); // показать рекламу
                    Intent intent = new Intent(Level5.this, Level6.class); //ИЗМЕНИТЬ
                    startActivity(intent);
                    finish();
                } else {
                    try {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(Level5.this);
                    Intent intent = new Intent(Level5.this, PlayGame.class); //Создали намерение для перехода
                    startActivity(intent);
                    finish();
                }else {
                    try {
        ...
        btn_up_left.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (mediaPlayer!=null){
                        releaseMP();
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.cucumber2); //Изменять
                        mediaPlayer.start();
        ...
        btn_up_right.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (mediaPlayer!=null){
                        releaseMP();
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.cucumber2);
                        mediaPlayer.start();
    ...
    protected void onResume() {
        ...
        if (mediaPlayer == null & Clicked == 0) { //Если свернули игру до нажатия варианта ответа
            mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.cucumber1);
            mediaPlayer.start();
