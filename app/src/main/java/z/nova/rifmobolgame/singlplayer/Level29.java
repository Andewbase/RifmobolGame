...
public class Level29 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_up_left.setTextSize(TypedValue.COMPLEX_UNIT_SP, 12);
        btn_up_right.setTextSize(TypedValue.COMPLEX_UNIT_SP, 10);
        btn_bottom_left.setTextSize(TypedValue.COMPLEX_UNIT_SP, 12);
        btn_bottom_right.setTextSize(TypedValue.COMPLEX_UNIT_SP, 12);
        //Меняем размер текста в кнопках конец

        //Меняем текст в кнопках - начало
        btn_up_left.setText(R.string.lvl29textone);
        btn_up_right.setText(R.string.lvl29texttwo);
        btn_bottom_left.setText(R.string.lvl29textthree);
        btn_bottom_right.setText(R.string.lvl29textfour);
        ...
        textdescriptions.setText(R.string.dialogwins4);
        //Устанавливаем текст в диалоговое окно - начало
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(Level29.this); //Показать рекламу
                    Intent intent = new Intent(Level29.this, PlayGame.class);
        ...
        buttoncontinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Level29.this, Level30.class); //ИЗМЕНИТЬ
                    startActivity(intent);
                    finish();
                }catch (Exception e){
                    //Пусто
        ...
        textdescriptionsl.setText(R.string.dialoglose4);
        //Устанавливаем текст в диалоговое окно - начало
            ...
            public void onClick(View v) {
                ...
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    ...
                    try {
                        ...
                        Intent intent = new Intent(Level29.this, PlayGame.class); //Создали намерение для перехода
                        startActivity(intent);
                        finish();
        ...
        btn_up_left.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (mediaPlayer!=null){
                        releaseMP();
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.tearing2); //Изменять
                        mediaPlayer.start();
