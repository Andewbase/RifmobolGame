...
class Level15 : AppCompatActivity() {
    ...
    val roundInfoImpl = RoundInfoImpl(15)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnclose.setOnClickListener {
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@Level15)
                val intent = Intent(this@Level15, PlayGame::class.java)
        ...
        buttoncontinue.setOnClickListener {
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@Level15)
                val intent = Intent(this@Level15, Level16::class.java) //ИЗМЕНИТЬ
                startActivity(intent)
                finish()
            } else {
                try {
        ...
        buttoncontinueback1.setOnClickListener {
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@Level15) // показать рекламу
                val intent = Intent(this@Level15, Level15::class.java)
                startActivity(intent)
                finish()
            } else {
                try {
        ...
        btn_back.setOnClickListener {
            ...
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@Level15) //Показать рекламу
                val intent =
                    Intent(this@Level15, PlayGame::class.java) //Создали намерение для перехода
                startActivity(intent)
                finish()
            } else {
                try {
