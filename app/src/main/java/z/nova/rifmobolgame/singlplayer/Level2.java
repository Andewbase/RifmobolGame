...
public class Level2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_up_left.setText(R.string.lvl2textone);
        btn_up_right.setText(R.string.lvl2texttwo);
        btn_bottom_left.setText(R.string.lvl2textthree);
        btn_bottom_right.setText(R.string.lvl2textfour);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(Level2.this); //Показать рекламу
                    Intent intent = new Intent(Level2.this, PlayGame.class);
        ...
        buttoncontinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Level2.this, Level3.class); //ИЗМЕНИТЬ
                    startActivity(intent);
                    finish();
                }catch (Exception e){
                    //Пусто
            ...
            public void onClick(View v) {
                ...
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    ...
                    try {
                        ...
                        Intent intent = new Intent(Level2.this, PlayGame.class); //Создали намерение для перехода
                        startActivity(intent);
                        finish();
        ...
        btn_up_left.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (mediaPlayer!=null){
                        releaseMP();
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.animals2); //Изменять
                        mediaPlayer.start();
