...
class Level6 : AppCompatActivity() {
    ...
    private val roundFactory = RoundFactory(6, this@Level6)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        roundFactory.dialogWinCreate(this@Level6, Level7::class.java) //TODO Установить следующий уровень
        //Вызов диалогового окна Выйграл "В Конце" - конец

        //Вызов диалогового окна Проиграл "В Конце" - начало
        roundFactory.dialogLoseCreate(this@Level6, Level6::class.java, Level7::class.java) //TODO Установить повторяющийся, следующий уровень
        //Вызов диалогового окна Проиграл "В Конце" - конец

        //Кнопка "Назад" - начало
        btnBack.setOnClickListener {
            //Обрабатывем нажатие кнопки "Назад" - начало
            roundFactory.clickBackButton(this@Level6)
        }
        //Кнопка "Назад" - конец
