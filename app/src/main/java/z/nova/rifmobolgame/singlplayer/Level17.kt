...
class Level17 : AppCompatActivity() {
    ...
    val roundInfoImpl = RoundInfoImpl(17)
   ...
   lateinit var dialogEndLose //Создаем Диалог Проиграл
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnclose.setOnClickListener {
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@Level17) //Показать рекламу
                val intent = Intent(this@Level17, PlayGame::class.java)
        ...
        buttoncontinue.setOnClickListener {
            try {
                val intent = Intent(this@Level17, Level18::class.java) //ИЗМЕНИТЬ
                startActivity(intent)
                finish()
            } catch (e: Exception) {
                //Пусто
        ...
        buttoncontinueback1.setOnClickListener {
            try {
                val intent = Intent(this@Level17, Level17::class.java)
                startActivity(intent)
                finish()
            } catch (e: Exception) {
                //Пусто
        ...
        btn_back.setOnClickListener {
            ...
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                ...
                try {
                    ...
                    val intent =
                        Intent(this@Level17, PlayGame::class.java) //Создали намерение для перехода
                    startActivity(intent)
                    finish()
    ...
    override fun onResume() {
        super.onResume()
        val btn_bottom_left =
            findViewById<View>(R.id.btn_left_bottom) as Button //Создаём нижнюю правую кнопку
