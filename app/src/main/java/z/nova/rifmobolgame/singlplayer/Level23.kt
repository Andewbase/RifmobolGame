...
class Level23 : AppCompatActivity() {
    ...
    private val singlRoundFactory = SinglRoundFactory(23, this@Level23)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        singlRoundFactory.dialogWinCreate(this@Level23, Level24::class.java) //TODO Установить следующий уровень
        //Вызов диалогового окна Выйграл "В Конце" - конец

        //Вызов диалогового окна Проиграл "В Конце" - начало
        singlRoundFactory.dialogLoseCreate(this@Level23, Level23::class.java, Level24::class.java) //TODO Установить повторяющийся, следующий уровень
        //Вызов диалогового окна Проиграл "В Конце" - конец

        //Кнопка "Назад" - начало
        btnBack.setOnClickListener {
            //Обрабатывем нажатие кнопки "Назад" - начало
            singlRoundFactory.clickBackButton(this@Level23)
        }
        //Кнопка "Назад" - конец
