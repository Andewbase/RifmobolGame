...
class Level20 : AppCompatActivity() {
    ...
    val roundInfoImpl = RoundInfoImpl(20)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnclose.setOnClickListener {
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@Level20)
                val intent = Intent(this@Level20, PlayGame::class.java)
        ...
        buttoncontinue.setOnClickListener {
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@Level20)
                val intent = Intent(this@Level20, Level21::class.java) //ИЗМЕНИТЬ
                startActivity(intent)
                finish()
            } else {
                try {
        ...
        buttoncontinueback1.setOnClickListener {
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@Level20) // показать рекламу
                val intent = Intent(this@Level20, Level20::class.java)
                startActivity(intent)
                finish()
            } else {
                try {
        ...
        btn_back.setOnClickListener {
            ...
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@Level20) //Показать рекламу
                val intent =
                    Intent(this@Level20, PlayGame::class.java) //Создали намерение для перехода
                startActivity(intent)
                finish()
            } else {
                try {
