...
class Level20 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        singlRoundFactory.dialogWinCreate(this@Level20, Level21::class.java)
        //Вызов диалогового окна Выйграл "В Конце" - конец

        //Вызов диалогового окна Проиграл "В Конце" - начало
        singlRoundFactory.dialogLoseCreate(this@Level20, Level20::class.java, Level21::class.java)
