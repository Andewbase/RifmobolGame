...
class Level4 : AppCompatActivity() {
    ...
    private val roundFactory = RoundFactory(4, this@Level4)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        roundFactory.dialogWinCreate(this@Level4, Level5::class.java) //TODO Установить следующий уровень
        //Вызов диалогового окна Выйграл "В Конце" - конец

        //Вызов диалогового окна Проиграл "В Конце" - начало
        roundFactory.dialogLoseCreate(this@Level4, Level4::class.java, Level5::class.java) //TODO Установить повторяющийся, следующий уровень
        //Вызов диалогового окна Проиграл "В Конце" - конец

        //Кнопка "Назад" - начало
        btnBack.setOnClickListener {
            //Обрабатывем нажатие кнопки "Назад" - начало
            roundFactory.clickBackButton(this@Level4)
        }
        //Кнопка "Назад" - конец
