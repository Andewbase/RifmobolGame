...
class Level4 : AppCompatActivity() {
    ...
    val roundInfoImpl = RoundInfoImpl(4)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnclose.setOnClickListener {
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@Level4) //Показать рекламу
                val intent = Intent(this@Level4, PlayGame::class.java)
        ...
        buttoncontinue.setOnClickListener {
            try {
                val intent = Intent(this@Level4, Level5::class.java) //ИЗМЕНИТЬ
                startActivity(intent)
                finish()
            } catch (e: Exception) {
                //Пусто
        ...
        buttoncontinueback1.setOnClickListener {
            try {
                val intent = Intent(this@Level4, Level4::class.java)
                startActivity(intent)
                finish()
            } catch (e: Exception) {
                //Пусто
        ...
        btn_back.setOnClickListener {
            ...
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                ...
                try {
                    ...
                    val intent =
                        Intent(this@Level4, PlayGame::class.java) //Создали намерение для перехода
                    startActivity(intent)
                    finish()
