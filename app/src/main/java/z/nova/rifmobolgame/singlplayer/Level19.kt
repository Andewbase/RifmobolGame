...
class Level19 : AppCompatActivity() {
    ...
    val roundInfoImpl = RoundInfoImpl(19)
   ...
   lateinit var dialogEndLose //Создаем Диалог Проиграл
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnclose.setOnClickListener {
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@Level19) //Показать рекламу
                val intent = Intent(this@Level19, PlayGame::class.java)
        ...
        buttoncontinue.setOnClickListener {
            try {
                val intent = Intent(this@Level19, Level20::class.java) //ИЗМЕНИТЬ
                startActivity(intent)
                finish()
            } catch (e: Exception) {
                //Пусто
        ...
        buttoncontinueback1.setOnClickListener {
            try {
                val intent = Intent(this@Level19, Level19::class.java)
                startActivity(intent)
                finish()
            } catch (e: Exception) {
                //Пусто
        ...
        btn_back.setOnClickListener {
            ...
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                ...
                try {
                    ...
                    val intent =
                        Intent(this@Level19, PlayGame::class.java) //Создали намерение для перехода
                    startActivity(intent)
                    finish()
    ...
    override fun onResume() {
        super.onResume()
        val btn_up_left =
            findViewById<View>(R.id.btn_left_up) as Button //Создаём нижнюю правую кнопку
