...
//Меняем размер текста в кнопках конец
        ...
        singlRoundFactory.dialogWinCreate(this@Level14, Level15::class.java)
        //Вызов диалогового окна Выйграл "В Конце" - конец

        //Вызов диалогового окна Проиграл "В Конце" - начало
        singlRoundFactory.dialogLoseCreate(this@Level14, Level14::class.java, Level15::class.java)
