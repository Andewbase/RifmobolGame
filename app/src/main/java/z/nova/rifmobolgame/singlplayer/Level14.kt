...
class Level14 : AppCompatActivity() {
    ...
    private val singlRoundFactory = SinglRoundFactory(14, this@Level14)
...
//Меняем размер текста в кнопках конец
        ...
        singlRoundFactory.dialogWinCreate(this@Level14, Level15::class.java) //TODO Установить следующий уровень
        //Вызов диалогового окна Выйграл "В Конце" - конец

        //Вызов диалогового окна Проиграл "В Конце" - начало
        singlRoundFactory.dialogLoseCreate(this@Level14, Level14::class.java, Level15::class.java) //TODO Установить повторяющийся, следующий уровень
        //Вызов диалогового окна Проиграл "В Конце" - конец

        //Кнопка "Назад" - начало
        btnBack.setOnClickListener {
            //Обрабатывем нажатие кнопки "Назад" - начало
            singlRoundFactory.clickBackButton(this@Level14)
        }
        //Кнопка "Назад" - конец
