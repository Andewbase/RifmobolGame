...
class Level14 : AppCompatActivity() {
    ...
    private val roundFactory = RoundFactory(14, this@Level14)
...
//Меняем размер текста в кнопках конец
        ...
        roundFactory.dialogWinCreate(this@Level14, Level15::class.java) //TODO Установить следующий уровень
        //Вызов диалогового окна Выйграл "В Конце" - конец

        //Вызов диалогового окна Проиграл "В Конце" - начало
        roundFactory.dialogLoseCreate(this@Level14, Level14::class.java, Level15::class.java) //TODO Установить повторяющийся, следующий уровень
        //Вызов диалогового окна Проиграл "В Конце" - конец

        //Кнопка "Назад" - начало
        btnBack.setOnClickListener {
            //Обрабатывем нажатие кнопки "Назад" - начало
            roundFactory.clickBackButton(this@Level14)
        }
        //Кнопка "Назад" - конец
