...
public class Level17 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_up_left.setText(R.string.lvl17textone);
        btn_up_right.setText(R.string.lvl17texttwo);
        btn_bottom_left.setText(R.string.lvl17textthree);
        btn_bottom_right.setText(R.string.lvl17textfour);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(Level17.this); //Показать рекламу
                    Intent intent = new Intent(Level17.this, PlayGame.class);
        ...
        buttoncontinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Level17.this, Level18.class); //ИЗМЕНИТЬ
                    startActivity(intent);
                    finish();
                }catch (Exception e){
                    //Пусто
            ...
            public void onClick(View v) {
                ...
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    ...
                    try {
                        ...
                        Intent intent = new Intent(Level17.this, PlayGame.class); //Создали намерение для перехода
                        startActivity(intent);
                        finish();
        ...
        btn_up_left.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (mediaPlayer!=null){
                        releaseMP();
                        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.iron2); //Изменять
                        mediaPlayer.start();
                    ...
                    mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                        ...
                        public void onCompletion(MediaPlayer mediaPlayer) {
                            btn_bottom_left.setBackground(getResources().getDrawable(R.drawable.style_btn_stroke_whiteblack_press_whitgreen));
    ...
    protected void onResume() {
        super.onResume();
        final Button btn_bottom_left = (Button) findViewById(R.id.btn_left_bottom);//Создаём нижнюю правую кнопку
