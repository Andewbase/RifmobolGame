...
import z.nova.rifmobolgame.data.local.GameData
...
import z.nova.rifmobolgame.data.local.GameData.listColorText
...
import z.nova.rifmobolgame.data.local.GameData.listTextMultiDialog
import z.nova.rifmobolgame.data.local.GameData.multiTextLevel
...
class GameRepositoryImplMulti: GameRepoMulti {

    override fun getMultiMusicRound(idLvl: Int): RoundMultiMusic {
        ...
        val resultBackgroundButtonRightAnswer = GameData.listBackgroundButtonRightAnswer

        return RoundMultiMusic(
            backgroundButtonRightAnswer = resultBackgroundButtonRightAnswer,
            music1 = resulMusic1,
            music2 = resulMusic2,
            p1leftUpButton = resultLeftUpButton as OneButtonInfo,
            p1rightUpButton = resultRightUpButton as OneButtonInfo,
            p1leftBottomButton = resultLeftBottomButton as OneButtonInfo,
            p1rightBottomButton = resultRightBottomButton as OneButtonInfo,
            p2leftUpButton = resultLeftUpButton,
            p2rightUpButton = resultRightUpButton,
            p2leftBottomButton = resultLeftBottomButton,
            p2rightBottomButton = resultRightBottomButton,
        )
    }

    override fun getMultiRoundInfo(idLvl: Int, numberRound: Int): RoundInfo {
        val resultTextLvl = when(numberRound){
            1 -> multiTextLevel[0]
            2 -> multiTextLevel[1]
            3 -> multiTextLevel[2]
            4 -> multiTextLevel[3]
    ...
    override fun getMultiDialog(scoreP1: Int, scoreP2: Int): DialogMultiText {
        val resultListText =  if (scoreP1 > scoreP2){
            listTextMultiDialog[0]
        }else if (scoreP1 < scoreP2){
            listTextMultiDialog[1]
        }else{
            listTextMultiDialog[2]
        }

        val resultListColor = if (scoreP1 > scoreP2){
            listColorText[0]
        }else if (scoreP1 < scoreP2){
            listColorText[1]
        }else{
        ...
        return DialogMultiText(textDialog = resultListText, colorText = resultListColor, scoreP1 = scoreP1, scoreP2 = scoreP2)
    }
