...
public class MultiLevelThree4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textlevel2.setText(R.string.lvlcouplet14);
        ...
        p1btn_up_left.setText(R.string.lvl14textone);
        p1btn_up_right.setText(R.string.lvl14texttwo);
        p1btn_bottom_left.setText(R.string.lvl14textthree);
        p1btn_bottom_right.setText(R.string.lvl14textfour);


        p2btn_up_left.setText(R.string.lvl14textone);
        p2btn_up_right.setText(R.string.lvl14texttwo);
        p2btn_bottom_left.setText(R.string.lvl14textthree);
        p2btn_bottom_right.setText(R.string.lvl14textfour);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(MultiLevelThree4.this); //Показать рекламу
                    Intent intent = new Intent(MultiLevelThree4.this, GameMenu.class); //Создали намерение для перехода
                ...
                public void onClick(View v) {
                    try {
                        ...
                        if (check == 2) {//Если нажали два раза
                            ...
                            if (mediaPlayer != null) {
                                releaseMP();
                                mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.gamlet2);
                                mediaPlayer.start();
                        ...
                        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                            ...
                            public void onCompletion(MediaPlayer mediaPlayer) {
                                ...
                                new Handler().postDelayed(new Runnable() {
                                    @Override
                                    public void run() {
                                        Intent intent = new Intent(MultiLevelThree4.this, MultiLevelThree5.class); //ИЗМЕНИТЬ
                                        startActivity(intent);
                                        finish();
                                    }
                                }, 500);
    ...
    protected void onResume() {
        ...
        if (check <= 1) { //Если свернули игру до нажатия варианта ответа, либо когда нажал только один игрок
            mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.gamlet1);
            mediaPlayer.start();
    ...
    public void onBackPressed(){
        if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
            ...
            try {
                Intent intent = new Intent(MultiLevelThree4.this, GameMenu.class);
                startActivity(intent);
                finish();
            } catch (Exception e) {
                //Пусто
