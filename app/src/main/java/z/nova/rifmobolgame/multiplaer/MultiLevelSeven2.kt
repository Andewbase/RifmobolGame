...
class MultiLevelSeven2 : AppCompatActivity() {
    ...
    private val multiLevelRoundFactory = MultiRoundFactory(32, this@MultiLevelSeven2)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Кнопка "Назад" - начало
        btnBack.setOnClickListener {multiLevelRoundFactory.clickBackButtonMulti(this@MultiLevelSeven2)}
        //Кнопка "Назад" - конец
