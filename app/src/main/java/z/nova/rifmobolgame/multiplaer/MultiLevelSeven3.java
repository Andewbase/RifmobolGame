...
public class MultiLevelSeven3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        background.setImageResource(R.drawable.level8_background);
        ...
        textlevel2.setText(R.string.lvlcouplet33);
        ...
        p1btn_up_left.setText(R.string.lvl33textone);
        p1btn_up_right.setText(R.string.lvl33textfour);
        p1btn_bottom_left.setText(R.string.lvl33textthree);
        p1btn_bottom_right.setText(R.string.lvl33texttwo);


        p2btn_up_left.setText(R.string.lvl33textone);
        p2btn_up_right.setText(R.string.lvl33textfour);
        p2btn_bottom_left.setText(R.string.lvl33textthree);
        p2btn_bottom_right.setText(R.string.lvl33texttwo);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(MultiLevelSeven3.this); //Показать рекламу
                    Intent intent = new Intent(MultiLevelSeven3.this, GameMenu.class); //Создали намерение для перехода
                ...
                public void onClick(View v) {
                    try {
                        ...
                        if (check == 2) {//Если нажали два раза
                            ...
                            if (mediaPlayer != null) {
                                releaseMP();
                                mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.eggs2);
                                mediaPlayer.start();
                        ...
                        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                            ...
                            public void onCompletion(MediaPlayer mediaPlayer) {
                                ...
                                new Handler().postDelayed(new Runnable() {
                                    @Override
                                    public void run() {
                                        Intent intent = new Intent(MultiLevelSeven3.this, MultiLevelSeven4.class);
                                        startActivity(intent);
                                        finish();
                                    }
                                }, 500);
    ...
    protected void onResume() {
       ...
       score2 = findViewById(R.id.scoree2);
        ...
        if (check <= 1) { //Если свернули игру до нажатия варианта ответа, либо когда нажал только один игрок
            mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.eggs1);
            mediaPlayer.start();
    ...
    public void onBackPressed(){
        if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
            ...
            try {
                Intent intent = new Intent(MultiLevelSeven3.this, GameMenu.class);
                startActivity(intent);
                finish();
            } catch (Exception e) {
                //Пусто
