...
class MultiLevelTwo4 : AppCompatActivity() {

    private val multiLevelRoundFactory = MultiRoundFactory(9, this@MultiLevelTwo4)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        p1btn_up_right.setTextSize(TypedValue.COMPLEX_UNIT_SP, 10f)
        ...
        p2btn_up_right.setTextSize(TypedValue.COMPLEX_UNIT_SP, 10f)
        ...
        //Кнопка "Назад" - начало
        btnBack.setOnClickListener {multiLevelRoundFactory.clickBackButtonMulti(this@MultiLevelTwo4)}
        //Кнопка "Назад" - конец


        p1btn_up_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p1btn_up_left, p1btn_bottom_right, p2btn_bottom_right, score1, score2, this@MultiLevelTwo4, MultiLevelTwo5::class.java)
        ...
        p1btn_up_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p1btn_up_right, p1btn_bottom_right, p2btn_bottom_right, score1, score2, this@MultiLevelTwo4, MultiLevelTwo5::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p1btn_bottom_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p1btn_bottom_left, p1btn_bottom_right, p2btn_bottom_right, score1, score2, this@MultiLevelTwo4, MultiLevelTwo5::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p1btn_bottom_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayer1Win(p1btn_bottom_right, p2btn_bottom_right, score1, score2, this@MultiLevelTwo4, MultiLevelTwo5::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_up_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p2btn_up_left, p1btn_bottom_right, p2btn_bottom_right, score1, score2, this@MultiLevelTwo4, MultiLevelTwo5::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_up_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p2btn_up_right, p1btn_bottom_right, p2btn_bottom_right, score1, score2, this@MultiLevelTwo4, MultiLevelTwo5::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_bottom_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p2btn_bottom_left, p1btn_bottom_right, p2btn_bottom_right, score1, score2, this@MultiLevelTwo4, MultiLevelTwo5::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_bottom_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayer2Win(p2btn_bottom_right, p1btn_bottom_right, score1, score2, this@MultiLevelTwo4, MultiLevelTwo5::class.java)
            //Метод показывающий правельный ответ - конец
    ...
    override fun onResume() {
        super.onResume()
        multiLevelRoundFactory.mediaStrartMulit(p1btn_bottom_right, p2btn_bottom_right, score1, score2, this@MultiLevelTwo4, MultiLevelTwo5::class.java)
    }

    //Системная кнопка "Назад" - начало
    override fun onBackPressed() {multiLevelRoundFactory.clickBackButtonMulti(this@MultiLevelTwo4)}
