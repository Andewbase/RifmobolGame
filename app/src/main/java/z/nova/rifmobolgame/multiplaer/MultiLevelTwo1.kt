...
class MultiLevelTwo1 : AppCompatActivity() {

    private val multiLevelRoundFactory = MultiRoundFactory(6, this@MultiLevelTwo1)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        p1btn_up_right.setPadding(7, 0, 7, 0)
        p1btn_bottom_right.setPadding(15, 0, 15, 0)
        p2btn_up_right.setPadding(7, 0, 7, 0)
        p2btn_bottom_right.setPadding(15, 0, 15, 0)
        ...
        //Кнопка "Назад" - начало
        btnBack.setOnClickListener {multiLevelRoundFactory.clickBackButtonMulti(this@MultiLevelTwo1)}
        //Кнопка "Назад" - конец


        p1btn_up_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p1btn_up_left, p1btn_bottom_left, p2btn_bottom_left, score1, score2, this@MultiLevelTwo1, MultiLevelTwo2::class.java)
        ...
        p1btn_up_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p1btn_up_right, p1btn_bottom_left, p2btn_bottom_left, score1, score2, this@MultiLevelTwo1, MultiLevelTwo2::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p1btn_bottom_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayer1Win(p1btn_bottom_left, p2btn_bottom_left, score1, score2, this@MultiLevelTwo1, MultiLevelTwo2::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p1btn_bottom_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p1btn_bottom_right, p1btn_bottom_left, p2btn_bottom_left, score1, score2, this@MultiLevelTwo1, MultiLevelTwo2::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_up_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p2btn_up_left, p1btn_bottom_left, p2btn_bottom_left, score1, score2, this@MultiLevelTwo1, MultiLevelTwo2::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_up_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p2btn_up_right, p1btn_bottom_left, p2btn_bottom_left, score1, score2, this@MultiLevelTwo1, MultiLevelTwo2::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_bottom_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayer2Win(p2btn_bottom_left, p1btn_bottom_left, score1, score2, this@MultiLevelTwo1, MultiLevelTwo2::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_bottom_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p2btn_bottom_right, p1btn_bottom_left, p2btn_bottom_left, score1, score2, this@MultiLevelTwo1, MultiLevelTwo2::class.java)
            //Метод показывающий правельный ответ - конец
    ...
    override fun onResume() {
        super.onResume()
       multiLevelRoundFactory.mediaStrartMulit(p1btn_bottom_left, p2btn_bottom_left, score1, score2, this@MultiLevelTwo1, MultiLevelTwo2::class.java)
    }

    //Системная кнопка "Назад" - начало
    override fun onBackPressed() {multiLevelRoundFactory.clickBackButtonMulti(this@MultiLevelTwo1)}
