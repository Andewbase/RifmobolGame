...
class MultiLevelSeven1 : AppCompatActivity() {
   ...
   lateinit var p2btn_bottom_left: Button
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        p1btn_up_left.setText(R.string.lvl31texttwo)
        p1btn_up_right.setText(R.string.lvl31textone)
        p1btn_bottom_left.setText(R.string.lvl31textthree)
        p1btn_bottom_right.setText(R.string.lvl31textfour)
        p2btn_up_left.setText(R.string.lvl31texttwo)
        p2btn_up_right.setText(R.string.lvl31textone)
        p2btn_bottom_left.setText(R.string.lvl31textthree)
        p2btn_bottom_right.setText(R.string.lvl31textfour)
        ...
        btn_back.setOnClickListener {
            ...
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@MultiLevelSeven1) //Показать рекламу
                val intent = Intent(
                    this@MultiLevelSeven1,
                    GameMenu::class.java
        ...
        p1btn_up_left.setOnClickListener(View.OnClickListener {
            try {
                ...
                if (check == 2) { //Если нажали два раза
                    ...
                    if (mediaPlayer != null) {
                        releaseMP()
                        mediaPlayer = MediaPlayer.create(applicationContext, R.raw.mexican2)
                        mediaPlayer?.start()
                ...
                mediaPlayer!!.setOnCompletionListener {
                    p1btn_up_left.setBackground(resources.getDrawable(R.drawable.style_btn_stroke_whiteblack_press_whitgreen))
                    p2btn_up_left.setBackground(resources.getDrawable(R.drawable.style_btn_stroke_whiteblack_press_whitgreen))
                    accrualOfPoints()
                    //ВЫХОД ИЗ ТРЭКА (Задержка 0.3 секунды) - Начало
                    Handler().postDelayed({
                        val intent =
                            Intent(this@MultiLevelSeven1, MultiLevelSeven2::class.java) //ИЗМЕНИТЬ
                        startActivity(intent)
                        finish()
                    }, 500)
                    //ВЫХОД ИЗ ТРЭКА (Задержка 0.3 секунды) - Начало
    ...
    override fun onResume() {
        ...
        p2btn_up_left =
            findViewById(R.id.p2btn_left_up) //Создаём нижнюю левую кнопку (второй игрок)
        if (check <= 1) { //Если свернули игру до нажатия варианта ответа, либо когда нажал только один игрок
            mediaPlayer = MediaPlayer.create(applicationContext, R.raw.mexican1)
            mediaPlayer?.start()
    ...
    override fun onBackPressed() {
        if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
            Yodo1Mas.getInstance().showInterstitialAd(this@MultiLevelSeven1) // показать рекламу
            val intent =
                Intent(this@MultiLevelSeven1, GameMenu::class.java) //Создали намерение для перехода
            startActivity(intent)
            finish()
        } else {
            try {
                val intent = Intent(this@MultiLevelSeven1, GameMenu::class.java)
                startActivity(intent)
                finish()
            } catch (e: Exception) {
                //Пусто
