...
public class MultiLevelThree5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textlevel2.setText(R.string.lvlcouplet15);
        ...
        p1btn_up_left.setText(R.string.lvl15textone);
        p1btn_up_right.setText(R.string.lvl15texttwo);
        p1btn_bottom_left.setText(R.string.lvl15textthree);
        p1btn_bottom_right.setText(R.string.lvl15textfour);


        p2btn_up_left.setText(R.string.lvl15textone);
        p2btn_up_right.setText(R.string.lvl15texttwo);
        p2btn_bottom_left.setText(R.string.lvl15textthree);
        p2btn_bottom_right.setText(R.string.lvl15textfour);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(MultiLevelThree5.this);
                    cleanResult();
                    Intent intent = new Intent(MultiLevelThree5.this, GameMenu.class);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(MultiLevelThree5.this); //Показать рекламу
                    Intent intent = new Intent(MultiLevelThree5.this, GameMenu.class); //Создали намерение для перехода
                    startActivity(intent);
                    finish();
                }else {
                    try {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        if (check == 2) {//Если нажали два раза
                            ...
                            if (mediaPlayer != null) {
                                releaseMP();
                                mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.grope2);
                                mediaPlayer.start();
    ...
    protected void onResume() {
       ...
       score2 = findViewById(R.id.scoree2);
        ...
        if (check <= 1) { //Если свернули игру до нажатия варианта ответа, либо когда нажал только один игрок
            mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.grope1);
            mediaPlayer.start();
