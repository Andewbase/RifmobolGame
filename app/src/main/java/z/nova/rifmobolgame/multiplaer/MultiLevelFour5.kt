...
class MultiLevelFour5 : AppCompatActivity() {
    ...
    private val multiLevelRoundFactory = MultiRoundFactory(20, this@MultiLevelFour5)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        multiLevelRoundFactory.dialogEndWinP1Create(this@MultiLevelFour5)
        multiLevelRoundFactory.dialogEndWinP2Create(this@MultiLevelFour5)
        multiLevelRoundFactory.dialogEndDrawreate(this@MultiLevelFour5)

        //Кнопка "Назад" - начало
        btnBack.setOnClickListener {multiLevelRoundFactory.clickBackButtonMulti(this@MultiLevelFour5)}
        //Кнопка "Назад" - конец
    ...
    override fun onBackPressed() {multiLevelRoundFactory.clickBackButtonMulti(this@MultiLevelFour5)}
