   ...
   lateinit var multiscoredraw: TextView
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnclose.setOnClickListener {
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@MultiLevelTwo5)
                cleanResult()
                val intent = Intent(this@MultiLevelTwo5, GameMenu::class.java)
        ...
        btn_back.setOnClickListener {
            ...
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@MultiLevelTwo5) //Показать рекламу
                val intent = Intent(
                    this@MultiLevelTwo5,
                    GameMenu::class.java
    ...
    override fun onResume() {
        ...
        if (check <= 1) { //Если свернули игру до нажатия варианта ответа, либо когда нажал только один игрок
            mediaPlayer = MediaPlayer.create(applicationContext, R.raw.discotwo1)
            mediaPlayer?.start()
