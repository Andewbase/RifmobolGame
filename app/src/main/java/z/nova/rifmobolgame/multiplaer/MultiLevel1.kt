...
class MultiLevel1 : AppCompatActivity() {
    ...
    private val multiLevelRoundFactory = MultiRoundFactory(1, this@MultiLevel1)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnBack = findViewById(R.id.button_back) //Кнопка "Назад" - начало

        multiLevelRoundFactory.setScoreText(score1, score2)

        btnBack.setOnClickListener {multiLevelRoundFactory.clickBackButtonMulti(this@MultiLevel1)} //Кнопка "Назад" - конец

        //Обрабатываем нажатие на "Левую Верхнюю Кнопку" - начало (первый игрок)
        p1btn_up_left.setOnClickListener {

            multiLevelRoundFactory.clickButtonPlayerLose(p1btn_up_left, p1btn_bottom_left, p2btn_bottom_left, score1, score2, this@MultiLevel1, MultiLevel2::class.java)
        ...
        p1btn_up_right.setOnClickListener {
            ...
            multiLevelRoundFactory.clickButtonPlayerLose(p1btn_up_right, p1btn_bottom_left, p2btn_bottom_left, score1, score2, this@MultiLevel1, MultiLevel2::class.java)
        ...
        p1btn_bottom_left.setOnClickListener{
            ...
            multiLevelRoundFactory.clickButtonPlayer1Win(p1btn_bottom_left, p2btn_bottom_left, score1, score2, this@MultiLevel1, MultiLevel2::class.java)
                //Метод показывающий правельный ответ - конец
        ...
        p1btn_bottom_right.setOnClickListener{
            multiLevelRoundFactory.clickButtonPlayerLose(p1btn_bottom_right, p1btn_bottom_left, p2btn_bottom_left, score1, score2, this@MultiLevel1, MultiLevel2::class.java)
                //Метод показывающий правельный ответ - конец
        ...
        p2btn_up_left.setOnClickListener{
            multiLevelRoundFactory.clickButtonPlayerLose(p2btn_up_left, p1btn_bottom_left, p2btn_bottom_left, score1, score2, this@MultiLevel1, MultiLevel2::class.java)
                //Метод показывающий правельный ответ - конец
        ...
        p2btn_up_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p2btn_up_right, p1btn_bottom_left, p2btn_bottom_left, score1, score2, this@MultiLevel1, MultiLevel2::class.java)
                //Метод показывающий правельный ответ - конец
        ...
        p2btn_bottom_left.setOnClickListener{
            multiLevelRoundFactory.clickButtonPlayer2Win(p2btn_bottom_left, p1btn_bottom_left, score1, score2, this@MultiLevel1, MultiLevel2::class.java)
                //Метод показывающий правельный ответ - конец
        ...
        p2btn_bottom_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p2btn_bottom_right, p1btn_bottom_left, p2btn_bottom_left, score1, score2, this@MultiLevel1, MultiLevel2::class.java)
                //Метод показывающий правельный ответ - конец
    ...
    override fun onResume() {
        super.onResume()
       multiLevelRoundFactory.mediaStrartMulit(p1btn_bottom_left, p2btn_bottom_left, score1, score2, this@MultiLevel1, MultiLevel2::class.java)
    }
    //Проигрываем музыку при запуске уровня - конец

    //Системная кнопка "Назад" - начало
    override fun onBackPressed() {
       multiLevelRoundFactory.clickBackButtonMulti(this@MultiLevel1)
    }
