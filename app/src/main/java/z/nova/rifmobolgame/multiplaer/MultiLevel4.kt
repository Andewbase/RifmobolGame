...
class MultiLevel4 : AppCompatActivity() {

    private val multiLevelRoundFactory = MultiRoundFactory(4, this@MultiLevel4)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        p1btn_bottom_left.setTextSize(TypedValue.COMPLEX_UNIT_SP, 14f)
        ...
        p2btn_bottom_left.setTextSize(TypedValue.COMPLEX_UNIT_SP, 14f)
        ...
        //Кнопка "Назад" - начало
        btnBack.setOnClickListener {multiLevelRoundFactory.clickBackButtonMulti(this@MultiLevel4)}
        //Кнопка "Назад" - конец

        //Обрабатываем нажатие на "Левую Верхнюю Кнопку" - начало (первый игрок)
        p1btn_up_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p1btn_up_left, p1btn_up_right, p2btn_up_right, score1, score2, this@MultiLevel4, MultiLevel5::class.java)
        ...
        p1btn_up_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayer1Win(p1btn_up_right, p2btn_up_right, score1, score2, this@MultiLevel4, MultiLevel5::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p1btn_bottom_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p1btn_bottom_left, p1btn_up_right, p2btn_up_right, score1, score2, this@MultiLevel4, MultiLevel5::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p1btn_bottom_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p1btn_bottom_right, p1btn_up_right, p2btn_up_right, score1, score2, this@MultiLevel4, MultiLevel5::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_up_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p2btn_up_left, p1btn_up_right, p2btn_up_right, score1, score2, this@MultiLevel4, MultiLevel5::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_up_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayer2Win(p2btn_up_right, p1btn_up_right, score1, score2, this@MultiLevel4, MultiLevel5::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_bottom_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p2btn_bottom_left, p1btn_up_right, p2btn_up_right, score1, score2, this@MultiLevel4, MultiLevel5::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_bottom_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p2btn_bottom_right, p1btn_up_right, p2btn_up_right, score1, score2, this@MultiLevel4, MultiLevel5::class.java)
            //Метод показывающий правельный ответ - конец
    ...
    override fun onResume() {
        ...
        multiLevelRoundFactory.mediaStrartMulit(p1btn_up_right, p2btn_up_right, score1, score2, this@MultiLevel4, MultiLevel5::class.java)
    }

    override fun onBackPressed() {multiLevelRoundFactory.clickBackButtonMulti(this@MultiLevel4)}//Системная кнопка "Назад"
