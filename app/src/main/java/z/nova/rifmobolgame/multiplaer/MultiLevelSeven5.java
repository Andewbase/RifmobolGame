...
public class MultiLevelSeven5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        p1btn_up_left.setText(R.string.lvl35textone);
        p1btn_up_right.setText(R.string.lvl35textfour);
        p1btn_bottom_left.setText(R.string.lvl35textthree);
        p1btn_bottom_right.setText(R.string.lvl35texttwo);


        p2btn_up_left.setText(R.string.lvl35textone);
        p2btn_up_right.setText(R.string.lvl35textfour);
        p2btn_bottom_left.setText(R.string.lvl35textthree);
        p2btn_bottom_right.setText(R.string.lvl35texttwo);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(MultiLevelSeven5.this);
                    cleanResult();
                    Intent intent = new Intent(MultiLevelSeven5.this, GameMenu.class);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(MultiLevelSeven5.this); //Показать рекламу
                    Intent intent = new Intent(MultiLevelSeven5.this, GameMenu.class); //Создали намерение для перехода
                    startActivity(intent);
                    finish();
                }else {
                    try {
