...
class MultiLevelSeven5 : AppCompatActivity() {
    ...
    private val multiLevelRoundFactory = MultiRoundFactory(35, this@MultiLevelSeven5)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        multiLevelRoundFactory.dialogEndWinP1Create(this@MultiLevelSeven5)
        multiLevelRoundFactory.dialogEndWinP2Create(this@MultiLevelSeven5)
        multiLevelRoundFactory.dialogEndDrawreate(this@MultiLevelSeven5)

        //Кнопка "Назад" - начало
        btnBack.setOnClickListener {multiLevelRoundFactory.clickBackButtonMulti(this@MultiLevelSeven5)}
        //Кнопка "Назад" - конец
    ...
    override fun onBackPressed() {multiLevelRoundFactory.clickBackButtonMulti(this@MultiLevelSeven5)}
