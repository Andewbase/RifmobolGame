...
class MultiLevel3 : AppCompatActivity() {

    private val multiLevelRoundFactory = MultiRoundFactory(3, this@MultiLevel3)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Кнопка "Назад" - начало
        btnBack.setOnClickListener {multiLevelRoundFactory.clickBackButtonMulti(this@MultiLevel3)}
        //Кнопка "Назад" - конец

        //Обрабатываем нажатие на "Левую Верхнюю Кнопку" - начало (первый игрок)
        p1btn_up_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p1btn_up_left, p1btn_up_right, p2btn_up_right, score1, score2, this@MultiLevel3, MultiLevel4::class.java)
        ...
        p1btn_up_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayer1Win(p1btn_up_right, p2btn_up_right, score1, score2, this@MultiLevel3, MultiLevel4::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p1btn_bottom_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p1btn_bottom_left, p1btn_up_right, p2btn_up_right, score1, score2, this@MultiLevel3, MultiLevel4::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p1btn_bottom_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p1btn_bottom_right, p1btn_up_right, p2btn_up_right, score1, score2, this@MultiLevel3, MultiLevel4::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_up_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p2btn_up_left, p1btn_up_right, p2btn_up_right, score1, score2, this@MultiLevel3, MultiLevel4::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_up_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayer2Win(p2btn_up_right, p1btn_up_right, score1, score2, this@MultiLevel3, MultiLevel4::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_bottom_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p2btn_bottom_left, p1btn_up_right, p2btn_up_right, score1, score2, this@MultiLevel3, MultiLevel4::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_bottom_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p2btn_bottom_right, p1btn_up_right, p2btn_up_right, score1, score2, this@MultiLevel3, MultiLevel4::class.java)
            //Метод показывающий правельный ответ - конец
    ...
    override fun onResume() {
        ...
        multiLevelRoundFactory.mediaStrartMulit(p1btn_up_right, p2btn_up_right, score1, score2, this@MultiLevel3, MultiLevel4::class.java)
    }

    override fun onBackPressed() {multiLevelRoundFactory.clickBackButtonMulti(this@MultiLevel3)}//Системная кнопка "Назад"
