...
public class MultiLevel3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textlevel2.setText(R.string.lvlcouplet3);
        ...
        p1btn_up_left.setText(R.string.lvl3textone);
        p1btn_up_right.setText(R.string.lvl3texttwo);
        p1btn_bottom_left.setText(R.string.lvl3textthree);
        p1btn_bottom_right.setText(R.string.lvl3textfour);


        p2btn_up_left.setText(R.string.lvl3textone);
        p2btn_up_right.setText(R.string.lvl3texttwo);
        p2btn_bottom_left.setText(R.string.lvl3textthree);
        p2btn_bottom_right.setText(R.string.lvl3textfour);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(MultiLevel3.this); //Показать рекламу
                    Intent intent = new Intent(MultiLevel3.this, GameMenu.class); //Создали намерение для перехода
                ...
                public void onClick(View v) {
                    try {
                        ...
                        if (check == 2) {//Если нажали два раза
                            ...
                            if (mediaPlayer != null) {
                                releaseMP();
                                mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.animalstwo2);
                                mediaPlayer.start();
                        ...
                        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                            ...
                            public void onCompletion(MediaPlayer mediaPlayer) {
                                ...
                                new Handler().postDelayed(new Runnable() {
                                    @Override
                                    public void run() {
                                        Intent intent = new Intent(MultiLevel3.this, MultiLevel4.class); //ИЗМЕНИТЬ
                                        startActivity(intent);
                                        finish();
                                    }
                                }, 500);
    ...
    protected void onResume() {
        ...
        if (check <= 1) { //Если свернули игру до нажатия варианта ответа, либо когда нажал только один игрок
            mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.animalstwo1);
            mediaPlayer.start();
    ...
    public void onBackPressed(){
        if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
            ...
            try {
                Intent intent = new Intent(MultiLevel3.this, GameMenu.class);
                startActivity(intent);
                finish();
            } catch (Exception e) {
                //Пусто
