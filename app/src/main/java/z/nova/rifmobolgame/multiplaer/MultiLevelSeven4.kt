...
class MultiLevelSeven4 : AppCompatActivity() {

    private val multiLevelRoundFactory = MultiRoundFactory(34, this@MultiLevelSeven4)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Меняем отступы для текста в кнопках - начало
        p1btn_bottom_left.setPadding(10, 0, 10, 0)
        p1btn_bottom_right.setPadding(10, 0, 10, 0)
        p2btn_bottom_left.setPadding(10, 0, 10, 0)
        p2btn_bottom_right.setPadding(10, 0, 10, 0)
        //Меняем отступы для текста в кнопках - конец
        ...
        //Кнопка "Назад" - начало
        btnBack.setOnClickListener {multiLevelRoundFactory.clickBackButtonMulti(this@MultiLevelSeven4)}
        //Кнопка "Назад" - конец

        //Обрабатываем нажатие на "Левую Верхнюю Кнопку" - начало (первый игрок)
        p1btn_up_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p1btn_up_left, p1btn_up_right, p2btn_up_right, score1, score2, this@MultiLevelSeven4, MultiLevelSeven5::class.java)
        ...
        p1btn_up_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayer1Win(p1btn_up_right, p2btn_up_right, score1, score2, this@MultiLevelSeven4, MultiLevelSeven5::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p1btn_bottom_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p1btn_bottom_left, p1btn_up_right, p2btn_up_right, score1, score2, this@MultiLevelSeven4, MultiLevelSeven5::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p1btn_bottom_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p1btn_bottom_right, p1btn_up_right, p2btn_up_right, score1, score2, this@MultiLevelSeven4, MultiLevelSeven5::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_up_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p2btn_up_left, p1btn_up_right, p2btn_up_right, score1, score2, this@MultiLevelSeven4, MultiLevelSeven5::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_up_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayer2Win(p2btn_up_right, p1btn_up_right, score1, score2, this@MultiLevelSeven4, MultiLevelSeven5::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_bottom_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p2btn_bottom_left, p1btn_up_right, p2btn_up_right, score1, score2, this@MultiLevelSeven4, MultiLevelSeven5::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_bottom_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p2btn_bottom_right, p1btn_up_right, p2btn_up_right, score1, score2, this@MultiLevelSeven4, MultiLevelSeven5::class.java)
            //Метод показывающий правельный ответ - конец
    ...
    override fun onResume() {
        ...
        multiLevelRoundFactory.mediaStrartMulit(p1btn_up_right, p2btn_up_right, score1, score2, this@MultiLevelSeven4, MultiLevelSeven5::class.java)
    }

    override fun onBackPressed() {multiLevelRoundFactory.clickBackButtonMulti(this@MultiLevelSeven4)}//Системная кнопка "Назад"
