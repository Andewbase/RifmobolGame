...
class MultiLevel5 : AppCompatActivity() {

    private val multiLevelRoundFactory = MultiRoundFactory(5, this@MultiLevel5)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        multiLevelRoundFactory.dialogEndWinP1Create(this@MultiLevel5)
        multiLevelRoundFactory.dialogEndWinP2Create(this@MultiLevel5)
        multiLevelRoundFactory.dialogEndDrawreate(this@MultiLevel5)

        //Кнопка "Назад" - начало
        btnBack.setOnClickListener {multiLevelRoundFactory.clickBackButtonMulti(this@MultiLevel5)}
        //Кнопка "Назад" - конец
    ...
    override fun onBackPressed() {multiLevelRoundFactory.clickBackButtonMulti(this@MultiLevel5)}
