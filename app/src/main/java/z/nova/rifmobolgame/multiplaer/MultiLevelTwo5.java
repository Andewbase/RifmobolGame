...
public class MultiLevelTwo5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textlevel2.setText(R.string.lvlcouplet10);
        ...
        p1btn_up_left.setText(R.string.lvl10textone);
        p1btn_up_right.setText(R.string.lvl10texttwo);
        p1btn_bottom_left.setText(R.string.lvl10textthree);
        p1btn_bottom_right.setText(R.string.lvl10textfour);


        p2btn_up_left.setText(R.string.lvl10textone);
        p2btn_up_right.setText(R.string.lvl10texttwo);
        p2btn_bottom_left.setText(R.string.lvl10textthree);
        p2btn_bottom_right.setText(R.string.lvl10textfour);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(MultiLevelTwo5.this);
                    cleanResult();
                    Intent intent = new Intent(MultiLevelTwo5.this, GameMenu.class);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(MultiLevelTwo5.this); //Показать рекламу
                    Intent intent = new Intent(MultiLevelTwo5.this, GameMenu.class); //Создали намерение для перехода
                    startActivity(intent);
                    finish();
                }else {
                    try {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        if (check == 2) {//Если нажали два раза
                            ...
                            if (mediaPlayer != null) {
                                releaseMP();
                                mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.discotwo2);
                                mediaPlayer.start();
    ...
    protected void onResume() {
       ...
       score2 = findViewById(R.id.scoree2);
        ...
        if (check <= 1) { //Если свернули игру до нажатия варианта ответа, либо когда нажал только один игрок
            mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.discotwo1);
            mediaPlayer.start();
