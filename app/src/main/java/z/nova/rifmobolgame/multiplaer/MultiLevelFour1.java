...
public class MultiLevelFour1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textlevel2.setText(R.string.lvlcouplet16);
        ...
        p1btn_up_left.setText(R.string.lvl16textone);
        p1btn_up_right.setText(R.string.lvl16texttwo);
        p1btn_bottom_left.setText(R.string.lvl16textthree);
        p1btn_bottom_right.setText(R.string.lvl16textfour);

        p2btn_up_left.setText(R.string.lvl16textone);
        p2btn_up_right.setText(R.string.lvl16texttwo);
        p2btn_bottom_left.setText(R.string.lvl16textthree);
        p2btn_bottom_right.setText(R.string.lvl16textfour);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(MultiLevelFour1.this); //Показать рекламу
                    Intent intent = new Intent(MultiLevelFour1.this, GameMenu.class); //Создали намерение для перехода
                ...
                public void onClick(View v) {
                    try {
                        ...
                        if (check == 2) {//Если нажали два раза
                            ...
                            if (mediaPlayer != null) {
                                releaseMP();
                                mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.ilove2);
                                mediaPlayer.start();
                        ...
                        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                            ...
                            public void onCompletion(MediaPlayer mediaPlayer) {
                                ...
                                new Handler().postDelayed(new Runnable() {
                                    @Override
                                    public void run() {
                                        Intent intent = new Intent(MultiLevelFour1.this, MultiLevelFour2.class); //ИЗМЕНИТЬ
                                        startActivity(intent);
                                        finish();
                                    }
                                }, 500);
    ...
    protected void onResume() {
       ...
       score2 = findViewById(R.id.scoree2);
        ...
        if (check <= 1) { //Если свернули игру до нажатия варианта ответа, либо когда нажал только один игрок
            mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.ilove1);
            mediaPlayer.start();
    ...
    public void onBackPressed(){
        if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
            ...
            try {
                Intent intent = new Intent(MultiLevelFour1.this, GameMenu.class);
                startActivity(intent);
                finish();
            } catch (Exception e) {
                //Пусто
