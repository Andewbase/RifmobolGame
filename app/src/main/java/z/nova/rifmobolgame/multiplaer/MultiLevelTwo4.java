...
public class MultiLevelTwo4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_levels.setText(R.string.raund4); //Установили текст

        //Устанавливаем фон для уровня - начало
        ImageView background = (ImageView) findViewById(R.id.menu_background);
        background.setImageResource(R.drawable.level9_background);
        ...
        textlevel2.setText(R.string.lvlcouplet9);
        ...
        p1btn_up_left.setText(R.string.lvl9textone);
        p1btn_up_right.setText(R.string.lvl9texttwo);
        p1btn_bottom_left.setText(R.string.lvl9textthree);
        p1btn_bottom_right.setText(R.string.lvl9textfour);


        p2btn_up_left.setText(R.string.lvl9textone);
        p2btn_up_right.setText(R.string.lvl9texttwo);
        p2btn_bottom_left.setText(R.string.lvl9textthree);
        p2btn_bottom_right.setText(R.string.lvl9textfour);
        //Меняем текст в кнопках - конец

        //Меняем размер текста в кнопках - начало
        p1btn_up_left.setTextSize(TypedValue.COMPLEX_UNIT_SP, 12);
        p1btn_up_right.setTextSize(TypedValue.COMPLEX_UNIT_SP, 10);
        p1btn_bottom_left.setTextSize(TypedValue.COMPLEX_UNIT_SP, 10);
        p1btn_bottom_right.setTextSize(TypedValue.COMPLEX_UNIT_SP, 10);

        p2btn_up_left.setTextSize(TypedValue.COMPLEX_UNIT_SP, 12);
        p2btn_up_right.setTextSize(TypedValue.COMPLEX_UNIT_SP, 10);
        p2btn_bottom_left.setTextSize(TypedValue.COMPLEX_UNIT_SP, 10);
        p2btn_bottom_right.setTextSize(TypedValue.COMPLEX_UNIT_SP, 10);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(MultiLevelTwo4.this); //Показать рекламу
                    Intent intent = new Intent(MultiLevelTwo4.this, GameMenu.class); //Создали намерение для перехода
                ...
                public void onClick(View v) {
                    try {
                        ...
                        if (check == 2) {//Если нажали два раза
                            ...
                            if (mediaPlayer != null) {
                                releaseMP();
                                mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.disco2);
                                mediaPlayer.start();
                        ...
                        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                            ...
                            public void onCompletion(MediaPlayer mediaPlayer) {
                                p1btn_bottom_right.setBackground(getResources().getDrawable(R.drawable.style_btn_stroke_whiteblack_press_whitgreen));
                                p2btn_bottom_right.setBackground(getResources().getDrawable(R.drawable.style_btn_stroke_whiteblack_press_whitgreen));
                                accrualOfPoints();
                                //ВЫХОД ИЗ ТРЭКА (Задержка 0.3 секунды) - Начало
                                new Handler().postDelayed(new Runnable() {
                                    @Override
                                    public void run() {
                                        Intent intent = new Intent(MultiLevelTwo4.this, MultiLevelTwo5.class);
                                        startActivity(intent);
                                        finish();
                                    }
                                }, 500);
    ...
    protected void onResume() {
       ...
       score2 = findViewById(R.id.scoree2);
        ...
        final Button p1btn_bottom_right = (Button) findViewById(R.id.p1btn_right_bottom);//Создаём нижнюю левую кнопку
        final Button p2btn_bottom_right = (Button) findViewById(R.id.p2btn_right_bottom);//Создаём нижнюю левую кнопку (второй игрок)
        if (check <= 1) { //Если свернули игру до нажатия варианта ответа, либо когда нажал только один игрок
            mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.disco1);
            mediaPlayer.start();
            ...
            mediaPlayer.start();
                ...
                mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    @Override
                    public void onCompletion(MediaPlayer mediaPlayer) {
                        p1btn_bottom_right.setBackgroundResource(R.drawable.style_btn_stroke_whiteblack_press_whitgreen);
                        p2btn_bottom_right.setBackgroundResource(R.drawable.style_btn_stroke_whiteblack_press_whitgreen);
                        accrualOfPoints();
                        //ВЫХОД ИЗ ТРЭКА (Задержка 0.3 секунды) - Начало
                        new Handler().postDelayed(new Runnable() {
                            @Override
    ...
    public void onBackPressed(){
        if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
            ...
            try {
                Intent intent = new Intent(MultiLevelTwo4.this, GameMenu.class);
                startActivity(intent);
                finish();
            } catch (Exception e) {
                //Пусто
