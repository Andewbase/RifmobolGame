...
public class MultiLevelFive5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        p1btn_up_left.setText(R.string.lvl25textone);
        p1btn_up_right.setText(R.string.lvl25texttwo);
        p1btn_bottom_left.setText(R.string.lvl25textthree);
        p1btn_bottom_right.setText(R.string.lvl25textfour);

        p2btn_up_left.setText(R.string.lvl25textone);
        p2btn_up_right.setText(R.string.lvl25texttwo);
        p2btn_bottom_left.setText(R.string.lvl25textthree);
        p2btn_bottom_right.setText(R.string.lvl25textfour);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(MultiLevelFive5.this);
                    cleanResult();
                    Intent intent = new Intent(MultiLevelFive5.this, GameMenu.class);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(MultiLevelFive5.this);
                    Intent intent = new Intent(MultiLevelFive5.this, GameMenu.class); //Создали намерение для перехода
                    startActivity(intent);
                    finish();
                }else {
                    try {
    ...
    public void onBackPressed(){
        if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
            Yodo1Mas.getInstance().showInterstitialAd(MultiLevelFive5.this); // показать рекламу
            Intent intent = new Intent(MultiLevelFive5.this, GameMenu.class);
            startActivity(intent);
            finish();
        }else {
