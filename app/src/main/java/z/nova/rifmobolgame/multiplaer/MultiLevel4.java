...
public class MultiLevel4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        background.setImageResource(R.drawable.level4_background);
        ...
        textlevel2.setText(R.string.lvlcouplet4);
        ...
        p1btn_up_left.setText(R.string.lvl4textone);
        p1btn_up_right.setText(R.string.lvl4texttwo);
        p1btn_bottom_left.setText(R.string.lvl4textthree);
        p1btn_bottom_right.setText(R.string.lvl4textfour);


        p2btn_up_left.setText(R.string.lvl4textone);
        p2btn_up_right.setText(R.string.lvl4texttwo);
        p2btn_bottom_left.setText(R.string.lvl4textthree);
        p2btn_bottom_right.setText(R.string.lvl4textfour);
        ...
        p1btn_bottom_left.setTextSize(TypedValue.COMPLEX_UNIT_SP, 14);
        ...
        p2btn_bottom_left.setTextSize(TypedValue.COMPLEX_UNIT_SP, 14);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
                    Yodo1Mas.getInstance().showInterstitialAd(MultiLevel4.this); //Показать рекламу
                    Intent intent = new Intent(MultiLevel4.this, GameMenu.class); //Создали намерение для перехода
                ...
                public void onClick(View v) {
                    try {
                        ...
                        if (check == 2) {//Если нажали два раза
                            ...
                            if (mediaPlayer != null) {
                                releaseMP();
                                mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.chaty2);
                                mediaPlayer.start();
                        ...
                        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                            ...
                            public void onCompletion(MediaPlayer mediaPlayer) {
                                ...
                                new Handler().postDelayed(new Runnable() {
                                    @Override
                                    public void run() {
                                        Intent intent = new Intent(MultiLevel4.this, MultiLevel5.class); //ИЗМЕНИТЬ
                                        startActivity(intent);
                                        finish();
                                    }
                                }, 500);
    ...
    protected void onResume() {
        ...
        if (check <= 1) { //Если свернули игру до нажатия варианта ответа, либо когда нажал только один игрок
            mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.chaty1);
            mediaPlayer.start();
    ...
    public void onBackPressed(){
        if (Yodo1Mas.getInstance().isInterstitialAdLoaded()) { //TODO
            ...
            try {
                Intent intent = new Intent(MultiLevel4.this, GameMenu.class);
                startActivity(intent);
                finish();
            } catch (Exception e) {
                //Пусто
