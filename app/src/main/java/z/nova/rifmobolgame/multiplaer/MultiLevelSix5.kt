...
class MultiLevelSix5 : AppCompatActivity() {
    ...
    private val multiLevelRoundFactory = MultiRoundFactory(30, this@MultiLevelSix5)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        multiLevelRoundFactory.dialogEndWinP1Create(this@MultiLevelSix5)
        multiLevelRoundFactory.dialogEndWinP2Create(this@MultiLevelSix5)
        multiLevelRoundFactory.dialogEndDrawreate(this@MultiLevelSix5)

        //Кнопка "Назад" - начало
        btnBack.setOnClickListener {multiLevelRoundFactory.clickBackButtonMulti(this@MultiLevelSix5)}
        //Кнопка "Назад" - конец
    ...
    override fun onBackPressed() {multiLevelRoundFactory.clickBackButtonMulti(this@MultiLevelSix5)}
