...
class MultiLevelSix5 : AppCompatActivity() {
  ...
  lateinit  var score1: TextView
   ...
   lateinit var multiscoredraw: TextView
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        p1btn_up_left.setText(R.string.lvl30textone)
        p1btn_up_right.setText(R.string.lvl30texttwo)
        p1btn_bottom_left.setText(R.string.lvl30textthree)
        p1btn_bottom_right.setText(R.string.lvl30textfour)
        p2btn_up_left.setText(R.string.lvl30textone)
        p2btn_up_right.setText(R.string.lvl30texttwo)
        p2btn_bottom_left.setText(R.string.lvl30textthree)
        p2btn_bottom_right.setText(R.string.lvl30textfour)
        ...
        btnclose.setOnClickListener {
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@MultiLevelSix5)
                cleanResult()
                val intent = Intent(this@MultiLevelSix5, GameMenu::class.java)
        ...
        btn_back.setOnClickListener {
            ...
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) { //TODO
                Yodo1Mas.getInstance().showInterstitialAd(this@MultiLevelSix5) //Показать рекламу
                val intent = Intent(
                    this@MultiLevelSix5,
                    GameMenu::class.java
        ...
        p1btn_up_left.setOnClickListener {
            try {
                ...
                if (check == 2) { //Если нажали два раза
                    ...
                    if (mediaPlayer != null) {
                        releaseMP()
                        mediaPlayer = MediaPlayer.create(applicationContext, R.raw.umbertrans2)
                        mediaPlayer?.start()
    ...
    override fun onResume() {
        ...
        if (check <= 1) { //Если свернули игру до нажатия варианта ответа, либо когда нажал только один игрок
            mediaPlayer = MediaPlayer.create(applicationContext, R.raw.umbertrans1)
            mediaPlayer?.start()
