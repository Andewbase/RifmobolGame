...
class MultiLevelThree5 : AppCompatActivity() {
    ...
    private val multiLevelRoundFactory = MultiRoundFactory(15, this@MultiLevelThree5)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        multiLevelRoundFactory.dialogEndWinP1Create(this@MultiLevelThree5)
        multiLevelRoundFactory.dialogEndWinP2Create(this@MultiLevelThree5)
        multiLevelRoundFactory.dialogEndDrawreate(this@MultiLevelThree5)

        //Кнопка "Назад" - начало
        btnBack.setOnClickListener {multiLevelRoundFactory.clickBackButtonMulti(this@MultiLevelThree5)}
        //Кнопка "Назад" - конец
    ...
    override fun onBackPressed() {multiLevelRoundFactory.clickBackButtonMulti(this@MultiLevelThree5)}
