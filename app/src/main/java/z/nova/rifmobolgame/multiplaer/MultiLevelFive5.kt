...
class MultiLevelFive5 : AppCompatActivity() {

    private val multiLevelRoundFactory = MultiRoundFactory(25, this@MultiLevelFive5)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        multiLevelRoundFactory.dialogEndWinP1Create(this@MultiLevelFive5)
        multiLevelRoundFactory.dialogEndWinP2Create(this@MultiLevelFive5)
        multiLevelRoundFactory.dialogEndDrawreate(this@MultiLevelFive5)

        //Кнопка "Назад" - начало
        btnBack.setOnClickListener {multiLevelRoundFactory.clickBackButtonMulti(this@MultiLevelFive5)}
        //Кнопка "Назад" - конец

        //Обрабатываем нажатие на "Левую Верхнюю Кнопку" - начало (первый игрок)
        p1btn_up_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayer1WinFinalRound(p1btn_up_left, p2btn_up_left, score1, score2)
        ...
        p1btn_up_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLoseFinalRound(p1btn_up_right, p1btn_up_left, p2btn_up_left, score1, score2)
            //Метод показывающий правельный ответ - конец
        ...
        p1btn_bottom_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLoseFinalRound(p1btn_bottom_left, p1btn_up_left, p2btn_up_left, score1, score2)
            //Метод показывающий правельный ответ - конец
        ...
        p1btn_bottom_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLoseFinalRound(p1btn_bottom_right, p1btn_up_left, p2btn_up_left, score1, score2)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_up_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayer2WinFinalRound(p2btn_up_left, p1btn_up_left, score1, score2)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_up_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLoseFinalRound(p2btn_up_right, p1btn_up_left, p2btn_up_left, score1, score2)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_bottom_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLoseFinalRound(p2btn_bottom_left, p1btn_up_left, p2btn_up_left, score1, score2)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_bottom_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLoseFinalRound(p2btn_bottom_right, p1btn_up_left, p2btn_up_left, score1, score2)
            //Метод показывающий правельный ответ - конец
    ...
    override fun onResume() {
        super.onResume()
        multiLevelRoundFactory.mediaStrartMulitFinalRound(p1btn_up_left, p2btn_up_left, score1, score2)
    }
    //Проигрываем музыку при запуске уровня - конец

    //Системная кнопка "Назад" - начало
    override fun onBackPressed() {multiLevelRoundFactory.clickBackButtonMulti(this@MultiLevelFive5)}
