...
class MultiLevelSix1 : AppCompatActivity() {

    private val multiLevelRoundFactory = MultiRoundFactory(26, this@MultiLevelSix1)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Кнопка "Назад" - начало
        btnBack.setOnClickListener {multiLevelRoundFactory.clickBackButtonMulti(this@MultiLevelSix1)}
        //Кнопка "Назад" - конец

        p1btn_up_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayer1Win(p1btn_up_left, p2btn_up_left, score1, score2, this@MultiLevelSix1, MultiLevelSix2::class.java)
        ...
        p1btn_up_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p1btn_up_right, p1btn_up_left, p2btn_up_left, score1, score2, this@MultiLevelSix1, MultiLevelSix2::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p1btn_bottom_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p1btn_bottom_left, p1btn_up_left, p2btn_up_left, score1, score2, this@MultiLevelSix1, MultiLevelSix2::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p1btn_bottom_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p1btn_bottom_right, p1btn_up_left, p2btn_up_left, score1, score2, this@MultiLevelSix1, MultiLevelSix2::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_up_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayer2Win(p2btn_up_left, p1btn_up_left, score1, score2, this@MultiLevelSix1, MultiLevelSix2::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_up_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p2btn_up_right, p1btn_up_left, p2btn_up_left, score1, score2, this@MultiLevelSix1, MultiLevelSix2::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_bottom_left.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p2btn_bottom_left, p1btn_up_left, p2btn_up_left, score1, score2, this@MultiLevelSix1, MultiLevelSix2::class.java)
            //Метод показывающий правельный ответ - конец
        ...
        p2btn_bottom_right.setOnClickListener {
            multiLevelRoundFactory.clickButtonPlayerLose(p2btn_bottom_right, p1btn_up_left, p2btn_up_left, score1, score2, this@MultiLevelSix1, MultiLevelSix2::class.java)
            //Метод показывающий правельный ответ - конец
    ...
    override fun onResume() {
        super.onResume()
        multiLevelRoundFactory.mediaStrartMulit(p1btn_up_left, p2btn_up_left, score1, score2, this@MultiLevelSix1, MultiLevelSix2::class.java)
    }

    //Системная кнопка "Назад" - начало
    override fun onBackPressed() {multiLevelRoundFactory.clickBackButtonMulti(this@MultiLevelSix1)}
