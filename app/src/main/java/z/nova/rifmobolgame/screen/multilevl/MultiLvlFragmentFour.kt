...
@AndroidEntryPoint
class MultiLvlFragmentFour : BaseMultiFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val callbackBackPressedCallback = requireActivity().onBackPressedDispatcher.addCallback(viewLifecycleOwner){
            if (Yodo1Mas.getInstance().isInterstitialAdLoaded) {
                ...
                val action = MultiLvlFragmentFourDirections.actionMultiLvlFragmentFragmentFourToMainMenuFragment()
    ...
    override fun onClick(v: View) {
        ...
        if(idButtonP1 > 0 && idButtonP2 > 0) {
            ...
            var idMultiLvl = safeArgs.idiMulitLvl
            ...
            viewModel.roundMusicLivedata.observe(viewLifecycleOwner) { music ->
                ...
                mediaPlayer!!.setOnCompletionListener {
                    ...
                    GlobalScope.launch(Dispatchers.Main) {
                        releaseMediaPlayer()
                        delay(DELAY)
                        val action = MultiLvlFragmentFourDirections.actionMultiLvlFragmentFragmentFourToMultiLvlFragmentFragmentFive(nextLevel, scoreP1, scoreP2)
                        findNavController().navigate(action)
                    }
                } //MediaPlayer.setOnCompletionListener
            } // viewModel.observe
